...
# x_train, y_train = readucr(root + "analysis.tsv")
# x_test, y_test = readucr(root + "analysis.tsv")
x, y = readucr(root + "analysis.tsv")

# automatically separate between test and training data from the same folder
